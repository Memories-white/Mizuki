...
export const siteConfig: SiteConfig = {
  ...
  siteURL: "http://www.zfps.asia/", // 请替换为你的站点URL，以斜杠结尾
  ...
  // 页面自动缩放配置。默认关闭，页面尺寸优先交由响应式布局处理。
  pageScaling: {
    enable: true, // 兼容旧站点的可选缩放；不建议通过根字号控制整体布局
  ...
  toc: {
    ...
    desktopSidebar: true, // 电脑端右侧栏 TOC
