...
类图展示了系统的静态结构，包括类、属性、方法以及它们之间的关系。
...
要使用 Mermaid，只需在代码块中指定 mermaid 语言，并用简洁的文本语法描述图表。Mermaid 会自动将这些描述转化为漂亮的视觉图表。

在你的下一篇技术博客文章或项目文档中尝试使用 Mermaid 图表吧——它们会让你的内容更专业、更易于理解！